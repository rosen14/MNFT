...
fig.add_trace(
    go.Scatter(
        ...
        mode='lines+markers', name = 'error L1 CN - 10000',
        marker=dict(
        size=8))
    )
fig.add_trace(
    go.Scatter(
        ...
        mode='lines+markers', name = 'error L1 BE - 10000',
        marker=dict(
        size=8))
    )
fig.add_trace(
    go.Scatter(
        ...
        mode='lines+markers', name = 'error L1 CN - 1000',
        marker=dict(
        size=8))
    )
fig.add_trace(
    go.Scatter(
        ...
        mode='lines+markers', name = 'error L1 BE - 1000',
        marker=dict(
        size=8))
    )
fig.add_trace(
    go.Scatter(
        ...
        y = np.array([0.002, 0.002*np.power(2, 4)]),
...
fig.add_trace(
    go.Scatter(
        x = np.array([discr_temp[-1], discr_temp[0]]),
        y = np.array([0.000003, 0.000003*np.power(4, 4)]),

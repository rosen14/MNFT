function [patches] = placa(xnod, faces, bf)
    ...
    patches{2}.faces = f_right; patches{2}.name = 'right'; patches{2}.type = 'Dirichlet'; patches{2}.value = 0;
    patches{3}.faces = f_top; patches{3}.name = 'top'; patches{3}.type = 'None'; patches{3}.value = 0;
    patches{4}.faces = f_bot;patches{4}.name = 'bottom'; patches{4}.type = 'NOne'; patches{4}.value = 0;
end

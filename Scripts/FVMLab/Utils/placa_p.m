function [patches] = placa_p(xnod, faces, bf)
    ...
    patches{1}.faces = f_left; patches{1}.name = 'left'; patches{1}.type = 'Dirichlet'; patches{1}.value = 10;
    patches{2}.faces = f_right; patches{2}.name = 'right'; patches{2}.type = 'Dirichlet'; patches{2}.value = 10;
    patches{3}.faces = f_top; patches{3}.name = 'top'; patches{3}.type = 'Neumann'; patches{3}.value = 0;
    patches{4}.faces = f_bot;patches{4}.name = 'bottom'; patches{4}.type = 'Neumann'; patches{4}.value = 0;
